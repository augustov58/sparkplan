...
// Sprint 2A M8: this page now uses the shared `themeStyles.page` wrapper +
// BrandBar + BrandFooter so the meter stack page reads as part of the
// permit packet (was a visual outlier before — see audit M8). Local styles
// kept for table/specs detail rendering only.
        ...
        return (
          <Page key={meterStack.id} size="LETTER" style={themeStyles.page}>
            ...
            <View style={themeStyles.titleBlock}>
              <Text style={themeStyles.docTitle}>Meter Stack Schedule</Text>
