    ...
    <div className="space-y-8 animate-in fade-in duration-500 max-w-6xl">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-[#888] mt-1">Define site parameters and electrical characteristics. Changes save automatically.</p>
        </div>
        {deleteProject && (
          <button
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="bg-white border border-[#e8e6e3] rounded-lg p-6 shadow-sm">
          <h3 className="text-lg font-medium text-[#1a1a1a] mb-6 flex items-center gap-2">
            <Building className="w-5 h-5 text-[#888]" /> General Information
          </h3>
          <div className="space-y-4">
            <div>
              <label className="block text-xs font-semibold text-[#888] uppercase mb-1">Project Name</label>
              <input
                type="text"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
               <div>
                <label className="block text-xs font-semibold text-[#888] uppercase mb-1">Building Type</label>
                <select
               ...
               <div>
                <label className="block text-xs font-semibold text-[#888] uppercase mb-1">NEC Edition</label>
                <select
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
               ...
               <div>
                  <label className="block text-xs font-semibold text-[#888] uppercase mb-1">Utility Provider</label>
                  <input
                    type="text"
        ...
        <div className="bg-white border border-[#e8e6e3] rounded-lg p-6 shadow-sm">
          <h3 className="text-lg font-medium text-[#1a1a1a] mb-6 flex items-center gap-2">
            <Zap className="w-5 h-5 text-[#2d3b2d]" /> System Characteristics
          </h3>
          
          <div className="p-4 bg-[#fff8e6] border border-[#c9a227]/30 rounded-md mb-6 flex gap-3">
             <AlertTriangle className="w-5 h-5 text-[#c9a227] flex-shrink-0" />
          ...
          <div className="space-y-4">
            <div>
              <label className="block text-xs font-semibold text-[#888] uppercase mb-1">Electrical System Type</label>
              {isResidential ? (
                // Locked for residential - always 120/240V single-phase
                <div className="flex items-center gap-2">
                  <div className="flex-1 px-3 py-2 bg-gray-50 border border-[#e8e6e3] rounded-md text-sm font-mono text-[#666]">
            ...
            <div className="pt-4 border-t border-[#f0eeeb]">
               <h4 className="text-sm font-medium text-[#1a1a1a] mb-3">Conductor Defaults</h4>
               <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                 <div>
                    <label className="block text-xs font-semibold text-[#888] uppercase mb-1">Material</label>
                    <select
                 ...
                 <div>
                    <label className="block text-xs font-semibold text-[#888] uppercase mb-1">Temp Rating</label>
                    <select
        ...
        {isResidential && (
          <div className="md:col-span-2 bg-gradient-to-br from-[#f0f5f0] to-[#e8f5e8] border border-[#3d6b3d]/30 rounded-lg p-6 shadow-sm">
            <h3 className="text-lg font-medium text-[#1a1a1a] mb-6 flex items-center gap-2">
              <Home className="w-5 h-5 text-[#3d6b3d]" /> Residential Settings
            </h3>
            
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {/* Dwelling Type */}
              <div>
                <label className="block text-xs font-semibold text-[#888] uppercase mb-1">Dwelling Type</label>
                <select
              ...
              {localProject.settings.residential?.dwellingType !== DwellingType.MULTI_FAMILY && (
                <div>
                  <label className="block text-xs font-semibold text-[#888] uppercase mb-1">Heated Square Footage</label>
                  <input
                    type="number"
              ...
              {localProject.settings.residential?.dwellingType === DwellingType.MULTI_FAMILY && (
                <div>
                  <label className="block text-xs font-semibold text-[#888] uppercase mb-1">Total Dwelling Units</label>
                  <input
                    type="number"
            ...
            <div className="mt-6 pt-6 border-t border-[#3d6b3d]/30">
              <h4 className="text-sm font-medium text-[#1a1a1a] mb-4 flex items-center gap-2">
                <Users className="w-4 h-4 text-[#3d6b3d]" /> Required Branch Circuits (NEC 210.11)
              </h4>
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full border-[#3d6b3d]/30 rounded-md text-sm bg-white"
                    min={2}
                  />
                  <p className="text-xs text-[#888] mt-1">Min: 2 required</p>
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    min={1}
                  />
                  <p className="text-xs text-[#888] mt-1">Min: 1 required</p>
                </div>
                ...
                <div className="flex items-center gap-2">
                  <input
                    ...
                    className="rounded border-[#3d6b3d]/40 text-[#3d6b3d] focus:ring-[#3d6b3d]/20"
                  />
                  <label htmlFor="laundryCircuit" className="text-sm text-[#666]">
                    Laundry Circuit <span className="text-xs text-[#888]">(required)</span>
                  </label>
                </div>
                ...
                <div className="flex items-center gap-2">
                  <input
                    ...
                    className="rounded border-[#3d6b3d]/40 text-[#3d6b3d] focus:ring-[#3d6b3d]/20"
                  />
                  <label htmlFor="garageCircuit" className="text-sm text-[#666]">
            ...
            {/* Tip for Residential */}
            <div className="mt-6 p-4 bg-[#e8f5e8]/50 border border-[#3d6b3d]/30 rounded-md">
